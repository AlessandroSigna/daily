...
<html>
	...
	<body>
		...
		if ($_SERVER["REQUEST_METHOD"] == "POST") 
		{
			...
			$result=$mysqli->query("INSERT INTO cliente (`mail_cliente`,`nome_cliente`,`cognome_cliente`,`password_cliente`,`spedizione_cliente`,`id_risposta`,`risposta_cliente`,`citta_cliente`,`telefono_cliente`) VALUES ('".$mail."','".$nome."','".$cognome."','".md5($pwd)."','".$spedizione."','".$domanda."','".$sicurezza."','".$citta."','".$telefono."')");
			if($result)
			{
