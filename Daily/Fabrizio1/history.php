...
<html>
	...
	<body>
		...
		<div id="resultPage">
			...
			<?php  echo '<h1>La tua cronologia acquisti</h1>'; 

			$query = $mysqli->query( " SELECT * FROM storico_acquisti JOIN magazzino ON storico_acquisti.ref_oggetto_SA=magazzino.ref_prodotto JOIN prodotto ON magazzino.ref_prodotto=prodotto.codice_prodotto WHERE (  ref_cliente_SA='$_SESSION[mailUtente]' )");
