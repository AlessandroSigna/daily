...
CREATE TABLE IF NOT EXISTS `DailyCollection`.`Storico_Acquisti` (
  ...
  `data_acquisto` VARCHAR(11) NOT NULL,
  ...
  `taglia_acquistati_SA` VARCHAR(5) NOT NULL,
  PRIMARY KEY (codice_fatturazione, ref_oggetto_SA, taglia_acquistati_SA ),
...
SELECT `storico_acquisti`.`codice_fatturazione`,
    ...
    `storico_acquisti`.`taglia_acquistati_SA`
